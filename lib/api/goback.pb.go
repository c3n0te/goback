...
type PortfolioResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	UserId        string                 `protobuf:"bytes,1,opt,name=UserId,proto3" json:"UserId,omitempty"`
	PortfolioLogs []*PortfolioLog        `protobuf:"bytes,2,rep,name=PortfolioLogs,proto3" json:"PortfolioLogs,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
type TransactionLogResponse struct {
	state           protoimpl.MessageState `protogen:"open.v1"`
	UserId          string                 `protobuf:"bytes,1,opt,name=UserId,proto3" json:"UserId,omitempty"`
	TransactionLogs []*TransactionLog      `protobuf:"bytes,2,rep,name=TransactionLogs,proto3" json:"TransactionLogs,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
const file_lib_api_goback_proto_rawDesc = "" +
	...
	"\x0fTransactionLogs\x18\x02 \x03(\v2\x13.api.TransactionLogR\x0fTransactionLogs\"\x11\n" +
...
var file_lib_api_goback_proto_msgTypes = make([]protoimpl.MessageInfo, 20)
...
var file_lib_api_goback_proto_depIdxs = []int32{
	7,  // 0: api.PortfolioResponse.PortfolioLogs:type_name -> api.PortfolioLog
	19, // 1: api.TransactionLogResponse.TransactionLogs:type_name -> api.TransactionLog
