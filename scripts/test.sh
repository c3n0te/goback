...
#MacOS
curl -X POST 127.0.0.1:8000/account -H "Content-Type: application/json" -d '{"Username":"c3n0te", "Email":"c3n0te@gmail.com", "Password":"secret", "Balance":1000.0}'
...
curl 127.0.0.1:8000/transactions
