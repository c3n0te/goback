...
curl.exe -X POST http://127.0.0.1:8000/buy/auto -H "Content-Type: application/json" -d '{\"Type\":\"AutoBuy\", \"UserId\":\"<Fill This In>\", \"Stock\":\"SPCX\", \"Shares\":10000.0, \"SharePrice\":97.52}'
...
curl.exe -X POST http://127.0.0.1:8000/sell/auto -H "Content-Type: application/json" -d '{\"Type\":\"AutoSell\", \"UserId\":\"<Fill This In>\", \"Stock\":\"GOOG\", \"Shares\":1000.0, \"SharePrice\":97.52}'
...
curl -X POST http://127.0.0.1:8000/account -H "Content-Type: application/json" -d '{"Username":"t0rch", "Email":"t0rch@gmail.com", "Password":"secret", "Balance":5000.0}'
curl -X POST 127.0.0.1:8000/buy -H "Content-Type: application/json" -d '{"Type":"Buy", "UserId":"<Fill This In>", "Stock":"AAPL", "Shares":5000.0}'
curl -X POST 127.0.0.1:8000/sell -H "Content-Type: application/json" -d '{"Type":"Sell", "UserId":"<Fill This In>", "Stock":"TSLA", "Shares":500.0}'
